...
class model(AbstractModel.model):
    ...
    def fit(self, nb_generations, nb_inds_each_task = 100,mutation_rate = 0.1,  evaluate_initial_skillFactor = True, *args, **kwargs) -> List[Individual]:
        ...
        for epoch in range(nb_generations):
            ...
            while len(offsprings) < len(population):
                ...
                if  random.random() > mutation_rate:
                    # crossover
                    skf_oa, skf_ob = pa.skill_factor, pb.skill_factor
            ...
            # selection
            self.selection(population, [nb_inds_each_task])
